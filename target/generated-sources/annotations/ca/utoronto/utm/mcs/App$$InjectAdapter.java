...
public final class App$$InjectAdapter extends Binding<App> {
  ...
  private Binding<APIHandler> httpHandler;
  ...
  public void attach(Linker linker) {
    ...
    httpHandler = (Binding<APIHandler>) linker.requestBinding("ca.utoronto.utm.mcs.APIHandler", App.class, getClass().getClassLoader());
  }
  ...
  public void getDependencies(Set<Binding<?>> getBindings, Set<Binding<?>> injectMembersBindings) {
    ...
    injectMembersBindings.add(httpHandler);
  }
  ...
  public void injectMembers(App object) {
    ...
    object.httpHandler = httpHandler.get();
  }
}
