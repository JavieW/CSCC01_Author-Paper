...
public final class DaggerModule$$ModuleAdapter extends ModuleAdapter<DaggerModule> {
  private static final String[] INJECTS = { "members/ca.utoronto.utm.mcs.App", "members/ca.utoronto.utm.mcs.APIHandler", "members/ca.utoronto.utm.mcs.MongoDB", };
  ...
  public void getBindings(BindingsGroup bindings, DaggerModule module) {
    ...
    bindings.contributeProvidesBinding("com.mongodb.client.MongoCollection<org.bson.Document>", new ProvideMongoCollectionProvidesAdapter(module));
  }
  ...
  /**
   * A {@code Binding<MongoCollection<Document>>} implementation which satisfies
   * Dagger's infrastructure requirements including:
   *
   * Being a {@code Provider<MongoCollection<Document>>} and handling creation and
   * preparation of object instances.
   */
  public static final class ProvideMongoCollectionProvidesAdapter extends ProvidesBinding<MongoCollection<Document>> {
    private final DaggerModule module;

    public ProvideMongoCollectionProvidesAdapter(DaggerModule module) {
      super("com.mongodb.client.MongoCollection<org.bson.Document>", NOT_SINGLETON, "ca.utoronto.utm.mcs.DaggerModule", "provideMongoCollection");
      this.module = module;
      setLibrary(true);
    }
    ...
    /**
     * Returns the fully provisioned instance satisfying the contract for
     * {@code Provider<MongoCollection<Document>>}.
     */
    @Override
    public MongoCollection<Document> get() {
      return module.provideMongoCollection();
    }
  }
}
